...
#        echo "${1}.gif.011 ${ARCHIVE2}/${2}F66.gif"
        mv ${1}.gif.011 ${ARCHIVE2}/${2}F66.gif
else
        cp black.gif $CURRENT/${3}F66.gif
        echo Did not find "${1}.gif.011"
        cp black.gif ${ARCHIVE2}/${2}F66.gif

endif

if (-f ${1}.gif.012 ) then
        cp ${1}.gif.012 $CURRENT/${3}F72.gif
#        echo "${1}.gif.012 ${ARCHIVE2}/${2}F72.gif"
        mv ${1}.gif.012 ${ARCHIVE2}/${2}F72.gif
else
        cp black.gif $CURRENT/${3}F72.gif
#        echo Did not find "${1}.gif.012"
        cp black.gif ${ARCHIVE2}/${2}F72.gif
